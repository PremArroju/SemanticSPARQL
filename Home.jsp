...
<body onload="loadMe();">
	...
	%>
		...
		<div class="container">
			...
			<div class="header">
			<img src="gobeachlogo.png" class="img">
			<h1>
				<b><span class="multicolor-blink">SPARQL Query Editor</span></b>
			</h1>
			</div>
			<form method="post" name="resultForm" action="Home.jsp" onSubmit="return saveComment();">
			
			<div class="col-85">
				<label for="file"><b> OWL File path<font color="red">*</font></b></label>
				<input type="text" id="myfile" name="myfile"
					placeholder="Enter OWL file path" />
			</div>
			...
			<div class="col-85">
				...
				<center>
					...
					<button type="reset" class="button"
						onclick="localStorage.removeItem('query'); document.getElementById('resultsdiv').style.display= 'none';">Delete</button>
				</center>
			</div>
